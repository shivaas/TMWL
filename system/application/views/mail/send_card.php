...
<head>
  ...
  <style>
    #epic_thanks a{
      background:url('./images/epic_thanks.jpg') no-repeat left top;
      float:left;
      text-indent:-99999px;
      height:88px;
      width:210px;
     ...
     #epic_thanks a:hover{
       background:url('./images/epic_thanks_hover.jpg') no-repeat left top;
       
     }
  </style>
</head>
<body>
<div style = "width:500px;height:600px;background-color:#CEE06E;padding:10px;display:block;">
  ...
  <div id="blue_block" style="background-color:#65C8C6;overflow:hidden;display:block;">
    <div id="view_card" style="float:left;font-family:Georgia; font-size:14px;color:#123242;padding:0px 20px;width:99%;">
      <p style="margin-top:15px;">
      	<?php echo '<strong>' . $message . '</strong>';?>
      </p>  
      <p>
        To see the card I created just for you, click the button below:
      </p> 
      <p style="text-align:center;margin-top:20px;">
        <a href="<?php echo $url;?>" style="text-decoration:none;border:none;"><img src="<?php echo site_url();?>images/view_my_note.jpg"  alt="view card" style="border:none;"/></a>
      </p>  
    </div>  
  </div>
  <div id="text" style="padding:0 10px;font-family:Georgia; font-size:14px;color:#123242;margin-top:10px">
  	<p>
       Epic Thanks is a global event in which participants like me share thanks with those we love, and give in honor of all we have to be grateful for.  Our combined gifts of gratitude will be invested in the dreams of <a href="<?php echo site_url() ?>/changemakers" style="color:#123242;">inspirational changemakers</a> who create hope in our world.
  	</p>
  	<p style="margin-top:15px">  
